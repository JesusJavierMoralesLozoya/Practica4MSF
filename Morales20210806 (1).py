...
plt.plot(t,Pp0,'-',linewidth=1,color=clr1,label='Pp(t):normotenso')
plt.plot(t,Pp1,'-',linewidth=1,color=clr2,label='Pp(t):hipotenso')
plt.plot(t,Pp3,':',linewidth=1,color=clr3,label='Pp(t):hipoPI')
plt.grid(False)
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel ('t[s]')
...
plt.plot(t,Pp0,'-',linewidth=1,color=clr1,label='Pp(t):normotenso')
plt.plot(t,Pp1,'-',linewidth=1,color=clr2,label='Pp(t):hipotenso')
plt.plot(t,Pp4,':',linewidth=1,color=clr3,label='Pp(t):hiperPI')
plt.grid(False)
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel ('t[s]')
